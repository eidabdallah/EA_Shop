...
namespace EA_Ecommerce.DAL.Data.Migrations
{
    ...
    [Migration("20251025111442_reviewUser")]
    partial class reviewUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EA_Ecommerce.DAL.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EA_Ecommerce.DAL.Models.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EA_Ecommerce.DAL.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EA_Ecommerce.DAL.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EA_Ecommerce.DAL.Models.Product", b =>
                {
                    b.HasOne("EA_Ecommerce.DAL.Models.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId");

                    b.HasOne("EA_Ecommerce.DAL.Models.Category", "Category")
                        .WithMany("products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasOne("EA_Ecommerce.DAL.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
